...
import { closeFormSuccess, resetPasswordSucces } from '../../Toolkits/restPasswordSlice';
...
const Recovery_Password = () => {
    ...
    const onFinish = async (values) => {
        let fetchResetPassword = async () => {
            try {
                let response = await userServ.resetPassword(values);
                dispatch((resetPasswordSucces()));
                localUserServ.remove(response.data)
